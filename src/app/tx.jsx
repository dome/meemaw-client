...
export default function Tx() {
    ...
    const handleGenerateWallet = async () => {
        ...
        const meemaw = await Meemaw.init('https://mw.lainet.xyz/');
    ...
    const handleGetWalletFromBackup = async () => {
        ...
        if (backup !== null) {
            ...
            const meemaw = await Meemaw.init('hhttps://mw.lainet.xyz');
    ...
    const handleSendTx = async () => {
        ...
        const web3 = new Web3(new Web3.providers.HttpProvider("https://rpc.mamoz.xyz"));
